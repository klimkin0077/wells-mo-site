...
export const siteMeta = {
  ...
  baseLocation: "Выезжаем по всей Московской области. Уточняем возможность выезда по адресу и объёму работ.",
...
export const trustMetrics = [
  { value: "01", label: "Московская область, выезд по всему региону" },
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Нет. Работаем по всей Московской области. Возможность выезда уточняем по адресу, объёму работ и состоянию объекта.",
      },
    ],
  },
  {
...
export const whyChooseUs = [
  ...
  },
  {
    ...
    text: "Выезжаем по всей Московской области. Уточняем возможность выезда по адресу, объёму работ и состоянию объекта.",
  },
] as const;
...
export const globalFaq = [
  {
    question: "Где вы работаете и как быстро можно договориться о выезде?",
      answer:
          "Работаем по всей Московской области. Выезд согласовываем по адресу, объёму работ и состоянию объекта.",
