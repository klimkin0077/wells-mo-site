...
export const siteMeta = {
  ...
  coverage: "Работаем по Московской области. Ориентир — до 100 км от МКАД.",
  baseLocation: "Приоритетные направления: Одинцово, Красногорск, Истра, Дмитров, Новорижское направление. Возможность выезда в другие районы уточняем по адресу, объёму работ и состоянию объекта.",
...
export const trustMetrics = [
  { value: "01", label: "Московская область до 100 км от МКАД" },
  { value: "02", label: "Понятная смета и честный разговор до начала работ" },
  { value: "03", label: "Реальные фото объектов и карточки выполненных работ" },
  { value: "04", label: "Чистка, ремонт, швы, скобирование и донный фильтр по факту задачи" },
] as const;
...
export const services: ServiceItem[] = [
  ...
  },
  {
    ...
    faq: [
      ...
      {
        question: "Работаете ли вы только по северу и северо-западу области?",
        answer:
          "Нет. Работаем по Московской области, ориентир — до 100 км от МКАД. Приоритетные направления: Одинцово, Красногорск, Истра, Дмитров и Новорижское направление. Возможность выезда в другие районы уточняем по адресу, объёму работ и состоянию объекта.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    description:
      "Скобирование фиксирует смещённые кольца и усиливает стык. В стандартном варианте — 3 скобы на один шов.",
    price: "от 1 500 ₽ / шов",
    image: assets.userShiftedRingRepair,
    highlights: [
    ...
    steps: [
      ...
      {
        title: "Подготовка шва",
        text: "Готовим шов и рабочие зоны под крепёж, чтобы скобы реально держали, а не стояли для вида.",
      },
      {
        title: "Фиксация",
...
export const whyChooseUs = [
  {
    title: "Сначала оцениваем задачу по фото или видео",
    text: "До выезда разбираем состояние объекта, чтобы заранее понимать объём работ и не везти на участок лишние сценарии ремонта.",
  },
  {
    title: "Смету согласовываем до начала работ",
    text: "Объясняем, какие этапы обязательны, где цена фиксированная, а где зависит от глубины, течей, швов и доступа к объекту.",
  },
  {
    title: "Показываем реальные работы и фото по объектам",
    text: "На сайте есть карточки выполненных работ по районам Московской области, чтобы было понятнее, как выглядит чистка, ремонт швов и восстановление дна на практике.",
  },
  {
    title: "Выезд по Московской области, дальние объекты — по согласованию",
    text: "Приоритетные направления — Одинцово, Красногорск, Истра, Дмитров и Новорижское направление. Другие районы тоже рассматриваем по адресу, объёму работ и состоянию объекта.",
  },
] as const;

export const pricing = [
  {
    service: "Чистка до 10 колец",
    price: "14 000 ₽",
    note: "Включает выезд, откачку воды, чистку дна от ила и песка, мойку шахты аппаратом высокого давления, осмотр швов и базовые рекомендации после работ.",
  },
  {
    service: "Чистка до 12 колец",
    price: "15 000 ₽",
    note: "Тот же базовый состав работ для более глубокой шахты без скрытого «от» в цене.",
  },
  {
    service: "Чистка до 14 колец",
    price: "16 000 ₽",
    note: "Подходит для типовых питьевых колодцев средней глубины с полной откачкой и мойкой шахты.",
  },
  {
    service: "Чистка до 16 колец",
    price: "18 000 ₽",
    note: "Цена фиксированная для этой глубины, если на объекте не требуется отдельный ремонт, осушка или материалы.",
  },
  {
    service: "Чистка 20 колец",
    price: "20 000 ₽",
    note: "Для глубоких шахт до 20 колец с базовой очисткой, мойкой, осмотром швов и рекомендациями после работ.",
  },
  {
    service: "Глубокие колодцы свыше 20–25 колец",
    price: "по расчёту",
    note: "Стоимость рассчитывается по глубине, доступу, состоянию шахты и условиям работы внутри ствола.",
  },
  {
    service: "Гидроизоляция шва",
    price: "3 000 ₽",
    note: "Локальная герметизация стандартного шва с подготовкой поверхности внутри шахты.",
  },
  {
    service: "Гидроизоляция текущего шва",
    price: "4 000 ₽",
    note: "Отдельная цена для активной течи, когда нужно быстро остановить поступление воды через шов.",
  },
  {
    service: "Ремонтный шов / разрыв 2–4 см",
    price: "6 000 ₽",
    note: "Восстановление проблемного шва или разрыва с ремонтом повреждённой зоны и последующей герметизацией.",
  },
  {
    service: "Ремонтный шов более 4 см",
    price: "от 6 000 ₽",
    note: "Цена зависит от глубины, состояния кольца и объёма разрушения в зоне ремонта.",
  },
  {
    service: "Скобирование шва",
    price: "1 500 ₽",
    note: "Усиление стыка кольца скобами для фиксации и стабилизации проблемной зоны.",
  },
  {
    service: "Заделка монтажного отверстия",
    price: "1 000 ₽",
    note: "Локальный ремонт технологического отверстия или аккуратной проходки в кольце.",
  },
  {
    service: "Ремонт переходного зазора между кольцами 1 м и 0,8 м",
    price: "12 000 ₽",
    note: "Сложный переходный узел с отдельной подготовкой и восстановлением сопряжения колец разных диаметров.",
  },
  {
    service: "Донный щит из лиственницы",
    price: "12 000 ₽",
    note: "Монтаж нового щита для восстановления нижней зоны колодца после осмотра основания шахты.",
  },
  {
    service: "Донный щит из осины",
    price: "8 000 ₽",
    note: "Более доступный вариант щита для нижней части колодца, если он подходит под задачу объекта.",
  },
  {
    service: "Засыпка гравия",
    price: "4 000 ₽",
    note: "Формирование фильтрующего слоя для стабилизации нижней зоны после чистки или ремонта.",
  },
  {
    service: "Засыпка галечника",
    price: "6 000 ₽",
    note: "Промытый галечник для нижнего фильтрующего слоя с учётом требуемого объёма материала.",
  },
  {
    service: "Установка насоса",
    price: "7 000 ₽",
    note: "Монтаж насоса в существующий колодец с подключением по месту без дополнительных опций.",
  },
  {
    service: "Монтаж насоса с греющим кабелем",
    price: "12 000 ₽",
    note: "Комплексный монтаж с греющим кабелем для стабильной работы системы в холодный сезон.",
  },
  {
    service: "Глиняный замок",
    price: "40 000 ₽",
    note: "Отдельная работа по внешней защите колодца от поверхностной воды вокруг шахты.",
  },
  {
    service: "Осушка рабочего места при высоком УГВ",
    price: "14 000 ₽",
    note: "Дополнительная позиция, если из-за высокого уровня грунтовых вод приходится отдельно осушать рабочую зону.",
  },
] as const;
...
export const cases = [
  {
    title: "Диагностика и подготовка к чистке",
    location: "Московская область, Дмитровский округ",
    service: "Комплексная чистка",
    stage: "Фото из архива работ",
    date: "Точная дата в архиве не сохранена",
    objectType: "Питьевой колодец",
    depth: "Глубина уточняется по архиву",
    workDone: ["осмотр шахты", "откачка воды", "подготовка к мойке и очистке дна"],
    total: "Смета по этому объекту в архиве не сохранена",
    result: "Показываем исходное состояние шахты перед полноценной чисткой: без ретуши и без постановочных фото.",
  ...
  },
  {
    ...
    service: "Комплексная чистка",
    stage: "Фото после работ",
    date: "Точная дата в архиве не сохранена",
    objectType: "Питьевой колодец",
    depth: "Количество колец уточняется по архиву",
    workDone: ["полная откачка воды", "мойка шахты аппаратом высокого давления", "чистка дна от ила и песка", "рекомендации по прокачке после работ"],
    total: "Итоговая стоимость по архиву не сохранена",
    result: "После мойки и очистки шахта визуально приведена в порядок, а состояние колодца стало понятным для дальнейшей эксплуатации.",
    image: assets.userAfterWashing,
  },
  {
    title: "Проблемный шов перед ремонтом",
    location: "Московская область, Одинцовский район",
    service: "Ремонт швов и герметизация",
    stage: "Фото до ремонта",
    date: "Точная дата в архиве не сохранена",
    objectType: "Питьевой колодец",
    depth: "Глубина шахты уточняется по архиву",
    workDone: ["локализация проблемного шва", "оценка поступления верховодки", "подготовка к герметизации и усилению стыка"],
    total: "Стоимость ремонта рассчитывалась по месту",
    result: "По фото видно типичный случай, когда течь идёт через шов и до начала работ важно понять объём восстановления, а не обещать фиксированную цену наугад.",
    image: assets.userCurrentJointProblem,
  },
  {
    title: "Шов после герметизации",
    location: "Московская область, Красногорск",
    service: "Гидроизоляция швов",
    stage: "Фото после работ",
    date: "Точная дата в архиве не сохранена",
    objectType: "Питьевой колодец",
    depth: "Количество колец уточняется по архиву",
    workDone: ["подготовка шва", "гидроизоляция проблемной зоны", "контрольный осмотр стыка после ремонта"],
    total: "Итоговая смета по архиву не сохранена",
    result: "После ремонта течь через шов остановлена, а стык подготовлен к дальнейшей эксплуатации без явного поступления воды.",
    image: assets.userJointWaterproofing,
  },
  {
    title: "Нижняя часть шахты до восстановления дна",
    location: "Московская область, Раменский округ",
    service: "Донный фильтр",
    stage: "Фото до работ",
    date: "Точная дата в архиве не сохранена",
    objectType: "Питьевой колодец",
    depth: "Глубина уточняется по архиву",
    workDone: ["осмотр нижней части шахты", "оценка основания", "подготовка под монтаж донного щита"],
    total: "Стоимость работ зависит от выбранного материала и объёма",
    result: "По карточке видно реальное состояние нижней зоны до восстановления фильтрующего слоя и монтажа материалов.",
    image: assets.userBottomShield,
  },
  {
    title: "Колодец после восстановления нижней зоны",
    location: "Московская область, Сергиево-Посадский район",
    service: "Донный фильтр",
    stage: "Фото после работ",
    date: "Точная дата в архиве не сохранена",
    objectType: "Питьевой колодец",
    depth: "Количество колец уточняется по архиву",
    workDone: ["монтаж донного щита", "засыпка фильтрующего слоя", "финишная очистка колодца"],
    total: "Финальная стоимость по архиву не сохранена",
    result: "После восстановления нижней зоны колодец вернули в рабочее состояние без лишней реконструкции шахты.",
...
export const globalFaq = [
  {
    question: "Где вы работаете и как быстро можно договориться о выезде?",
      answer:
          "Работаем по Московской области, ориентир — до 100 км от МКАД. Приоритетные направления: Одинцово, Красногорск, Истра, Дмитров и Новорижское направление. Выезд в другие районы согласовываем по адресу, объёму работ и состоянию объекта.",
...
export const citySeoLocations: LocalSeoLocation[] = [
  ...
  ["Новая Рига", "Новорижское направление"],
