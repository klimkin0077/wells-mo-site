...
export const pricing = [
  {
    service: "Чистка питьевого колодца",
    price: "14 000 ₽",
    note: "Глубина, состояние шахты, объём ила, песка, запаха и необходимость дезинфекции",
  },
  {
    service: "Чистка дренажного колодца",
    price: "от 18 000 ₽",
    note: "Глубина, количество осадка, доступ к шахте и объём откачки",
  },
  {
    service: "Промазка сухого шва",
    price: "от 3 000 ₽",
    note: "Глубина проблемного участка, подготовка поверхности и объём локальных работ",
  },
  {
    service: "Промазка мокрого или текущего шва",
    price: "от 4 000 ₽",
    note: "Активная течь, глубина шва и необходимость дополнительной гидропломбы",
  },
  {
    service: "Скобирование шва",
    price: "от 1 500 ₽",
    note: "Количество точек фиксации, состояние колец и доступ к месту ремонта",
  },
  {
    service: "Заделка монтажного отверстия",
    price: "от 1 000 ₽",
    note: "Размер отверстия, глубина и материал закрытия",
  },
  {
    service: "Донный щит из лиственницы",
    price: "от 10 000 ₽",
    note: "Диаметр шахты, сложность монтажа и состояние дна",
  },
  {
    service: "Засыпка речного гравия",
    price: "от 5 000 ₽",
    note: "Толщина слоя, объём материала и состояние нижней части колодца",
  },
  {
    service: "Подводка воды в дом",
    price: "от 2 500 ₽ / пог. м",
    note: "Метраж трассы, глубина, тип грунта и набор оборудования",
  },
  {
    service: "Монтаж насоса",
    price: "от 7 000 ₽",
    note: "Тип насоса, схема автоматики и условия монтажа на объекте",
  },
  {
    service: "Септик из ЖБ колец",
    price: "от 11 000 ₽ за кольцо Ø1 м",
    note: "Количество колец, конфигурация септика, материалы, доставка и монтаж",
  },
  {
    service: "Выезд и диагностика",
    price: "от 6 000 ₽",
    note: "Удалённость, сложность задачи и объём инженерного осмотра",
  },
] as const;
...
export const processSteps = [
  ...
  },
  {
    ...
    text: "От очистки и ремонта до гидроизоляции, скобирования и углубления — без лишних действий и визуального хаоса.",
  },
  {
    number: "04",
