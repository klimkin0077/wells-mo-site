...
export const siteMeta = {
  ...
  baseLocation: "Приоритетные направления: Одинцово, Красногорск, Истра, Дмитров, Новорижское направление. Выезд в другие районы Московской области уточняем по адресу.",
...
export const trustMetrics = [
  { value: "01", label: "Московская область: Одинцово, Красногорск, Истра, Дмитров и Новорижское направление" },
...
export const services: ServiceItem[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Работа по Московской области с приоритетом на Одинцово, Истру, Дмитров и Новорижское направление",
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Да, работаем по Московской области. Приоритетные направления — Одинцово, Истра, Дмитров, Красногорск и Новорижское направление; выезд в другие районы уточняем по адресу.",
      },
    ],
  },
  {
...
export const whyChooseUs = [
  {
    ...
    text: "Оцениваем состояние колодца, объясняем, что действительно нужно сделать, и не раздуваем объём работ без причины.",
  },
  {
...
export const pricing = [
  {
    ...
    price: "от 14 000 ₽",
    note: "Откачка воды, мойка шахты, очистка дна и базовая дезинфекция в одном выезде. Точная смета зависит от глубины, состояния шахты и дополнительных работ.",
  },
  {
  ...
  },
  {
    ...
    price: "от 1 500 ₽ / шов",
    note: "Скобирование фиксирует смещённые кольца и усиливает стык. В стандартном варианте — 3 скобы на один шов.",
  },
  {
    service: "Фильтр из лиственницы",
    price: "от 12 000 ₽",
    note: "Монтаж донного фильтра из лиственницы для восстановления нижней части колодца после осмотра основания шахты.",
  },
  {
    service: "Речная галька 150 кг",
    price: "от 8 000 ₽",
    note: "Промытая речная галька для фильтрующего слоя и стабилизации дна шахты. Стоимость зависит от состава работ и логистики.",
  },
  {
    service: "Гравийный щебень 150 кг",
    price: "от 5 000 ₽",
    note: "Щебёночная засыпка для нижнего слоя и выравнивания рабочего основания с учётом состояния дна и объёма материала.",
  },
] as const;
...
export const globalFaq = [
  {
    ...
    answer:
          "Работаем по Московской области. Приоритетные направления: Одинцово, Красногорск, Истра, Дмитров, Новорижское направление. Возможность выезда в другие районы Московской области уточняем по адресу и состоянию объекта.",
