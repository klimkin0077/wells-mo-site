...
export const siteMeta = {
  ...
  baseLocation: "Приоритет: Одинцово, Красногорск, Истра, Дмитров, Новорижское направление и соседние районы.",
...
export const trustMetrics = [
  { value: "01", label: "Одинцово, Красногорск, Истра, Дмитров и северо-запад Московской области" },
