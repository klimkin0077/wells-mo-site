    ...
    <section className="py-12 lg:py-16">
      <div className="container space-y-10">
        <SectionHeading
          ...
          title="Работаем по всей Московской области"
          description="Выезжаем по всей Московской области. Возможность выезда уточняем по адресу, объёму работ и состоянию объекта."
        />
        ...
        <div className="container grid gap-8 xl:grid-cols-[0.9fr_1.1fr]">
          <div className="page-frame rounded-[2rem] p-6 lg:p-8">
            ...
            <div className="mt-5 space-y-5 text-white/72">
              ...
              <p className="story-copy">
                Работаем по всей Московской области. Сообщите район, задачу и текущее состояние колодца, чтобы быстрее понять формат работ и сориентировать вас по выезду.
              </p>
...
{" "}
                ...
                . Работаем по всей Московской области. Возможность выезда уточняем по адресу и объёму работ.
              </p>
            </form>
          </div>
        </div>
